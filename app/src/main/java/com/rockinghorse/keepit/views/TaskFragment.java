...
public class TaskFragment extends Fragment {
     ...
     * number.
     */
    public static TaskFragment newInstance(int sectionNumber, CharSequence pageTitle) {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        TaskStatus ts;
        switch (getArguments().getString(ARG_FRAGMENT_TITLE)) {
            case MainActivity.TODO_FRAGMENT_NAME:
                ts = new ToDoStatus();
                break;
            case MainActivity.DOING_FRAGMENT_NAME:
                ts = new DoingStatus();
                break;
            case MainActivity.DONE_FRAGMENT_NAME:
                ts = new DoneStatus();
                break;
            default:
                ts = new ToDoStatus();
